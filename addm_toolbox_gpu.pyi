...
class DDM:
    ...
    def compute_GPUNLL(self, trials: List[DDMTrial], debug: bool = ..., trialsPerThread: int = ..., timeStep: int = ..., approxStateStep: float = ...) -> ProbabilityData: ...
    def exportTrial(self, arg0: DDMTrial, arg1: str) -> None: ...
    @classmethod
    def fitModelMLE(cls, *args, **kwargs) -> MLEinfoDDM: ...
...
class DDMTrial:
    ...
    @classmethod
    def loadTrialsFromCSV(cls, arg0: str) -> List[DDMTrial]: ...
    @classmethod
    def writeTrialsToCSV(cls, arg0: List[DDMTrial], arg1: str) -> None: ...
    @property
...
class aDDM(DDM):
    ...
    def computeGPUNLL(self, trials: List[aDDMTrial], debug: bool = ..., trialsPerThread: int = ..., timeStep: int = ..., approxStateStep: float = ...) -> ProbabilityData: ...
    ...
    @classmethod
    def fitModelMLE(cls, *args, **kwargs) -> MLEinfoaDDM: ...
