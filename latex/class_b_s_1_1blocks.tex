\doxysection{BS\+::blocks\texorpdfstring{$<$}{<} T1, T2, T \texorpdfstring{$>$}{>} Class Template Reference}
\hypertarget{class_b_s_1_1blocks}{}\label{class_b_s_1_1blocks}\index{BS::blocks$<$ T1, T2, T $>$@{BS::blocks$<$ T1, T2, T $>$}}
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00138}{138}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.



\doxysubsection{Constructor \& Destructor Documentation}
\Hypertarget{class_b_s_1_1blocks_a2e938fc32ea845e8a0cf23025c6830c7}\label{class_b_s_1_1blocks_a2e938fc32ea845e8a0cf23025c6830c7} 
...
\mbox{\hyperlink{class_b_s_1_1blocks}{BS\+::blocks}}$<$ T1, T2, T $>$\+::blocks (\begin{DoxyParamCaption}\item[{const T1}]{first\+\_\+index\+\_\+,  }\item[{const T2}]{index\+\_\+after\+\_\+last\+\_\+,  }\item[{const size\+\_\+t}]{num\+\_\+blocks\+\_\+ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00148}{148}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00148\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ first\_index(\textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(first\_index\_)),\ index\_after\_last(\textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(index\_after\_last\_)),\ num\_blocks(num\_blocks\_)}
\DoxyCodeLine{00149\ \ \ \ \ \{}
\DoxyCodeLine{00150\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (index\_after\_last\ <\ first\_index)}
\DoxyCodeLine{00151\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacestd_ab5fa3119ddc434392ecca8849e2e08e1}{std::swap}}(index\_after\_last,\ first\_index);}
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ total\_size\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(index\_after\_last\ -\/\ first\_index);}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ block\_size\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(total\_size\ /\ num\_blocks);}
\DoxyCodeLine{00154\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (block\_size\ ==\ 0)}
\DoxyCodeLine{00155\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00156\ \ \ \ \ \ \ \ \ \ \ \ \ block\_size\ =\ 1;}
\DoxyCodeLine{00157\ \ \ \ \ \ \ \ \ \ \ \ \ num\_blocks\ =\ (total\_size\ >\ 1)\ ?\ total\_size\ :\ 1;}
\DoxyCodeLine{00158\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00159\ \ \ \ \ \}}
...
\Hypertarget{class_b_s_1_1blocks_a0f0e08f9eff06a0d8e3b05bf59833c7b}\label{class_b_s_1_1blocks_a0f0e08f9eff06a0d8e3b05bf59833c7b} 
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00178}{178}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00179\ \ \ \ \ \{}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ (i\ ==\ num\_blocks\ -\/\ 1)\ ?\ index\_after\_last\ :\ (\textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}((i\ +\ 1)\ *\ block\_size)\ +\ first\_index);}
\DoxyCodeLine{00181\ \ \ \ \ \}}

\end{DoxyCode}
\Hypertarget{class_b_s_1_1blocks_aed50be83dbe428959cb600197df32c95}\label{class_b_s_1_1blocks_aed50be83dbe428959cb600197df32c95} 
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00188}{188}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00189\ \ \ \ \ \{}
\DoxyCodeLine{00190\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ num\_blocks;}
\DoxyCodeLine{00191\ \ \ \ \ \}}

\end{DoxyCode}
\Hypertarget{class_b_s_1_1blocks_a5f1214e4fdf05ff4d825d08cf8c66b2b}\label{class_b_s_1_1blocks_a5f1214e4fdf05ff4d825d08cf8c66b2b} 
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00198}{198}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00199\ \ \ \ \ \{}
\DoxyCodeLine{00200\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ total\_size;}
\DoxyCodeLine{00201\ \ \ \ \ \}}

\end{DoxyCode}
\Hypertarget{class_b_s_1_1blocks_a7d659984a82cf57e54773d9a88d863ae}\label{class_b_s_1_1blocks_a7d659984a82cf57e54773d9a88d863ae} 
...
Definition at line \mbox{\hyperlink{_b_s__thread__pool_8hpp_source_l00167}{167}} of file \mbox{\hyperlink{_b_s__thread__pool_8hpp_source}{BS\+\_\+thread\+\_\+pool.\+hpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00168\ \ \ \ \ \{}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(i\ *\ block\_size)\ +\ first\_index;}
\DoxyCodeLine{00170\ \ \ \ \ \}}
